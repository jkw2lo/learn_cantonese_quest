...
/* ---------- reference glosses ----------
   ...
   362 of them. */
const EXTRA_GLOSS = {"丁":["ding1","male adult; robust"],"下":["haa6","under; underneath"],"且":["ce2","moreover; also (post-subject)"],"丙":["bing2","third; 3rd heavenly stem"],"丩":["gau2","to join or connect the vine"],"中":["zung1","central; center"],"主":["zyu2","master; chief owner"],"乙":["jyut3","second; 2nd heavenly stem"],"乾":["kin4","dry; warming principle of the sun"],"事":["si6","affair; matter"],"交":["gaau1","mix; intersect"],"以":["ji5","by means of; thereby"],"件":["gin6","numerary adjunct for article; matter"],"份":["fan6","portion; part"],"位":["wai6","throne; position"],"低":["dai1","low; to lower"],"佛":["fat6","Buddha; of Buddhism"],"作":["zok3","make; work"],"佬":["lou2","(Cant.) man; person"],"佳":["gaai1","good; auspicious"],"使":["si2","cause; send on a mission"],"例":["lai6","precedent; example"],"便":["bin6","convenience; ease"],"倒":["dou2","fall over; lie down"],"假":["gaa2","falsehood; deception"],"備":["bei6","prepare; ready"],"兄":["hing1","elder brother"],"克":["hak1","gram; overcome"],"免":["min5","spare; excuse from"],"最":["zeoi3","most; extremely"],"冫":["bing1","ice"],"冷":["laang5","cold; cool"],"刀":["dou1","knife; old coin"],"切":["cit3","cut; mince"],"利":["lei6","gains; advantage"],"到":["dou3","go to; arrive"],"剌":["laat6","slash; cut in two"],"劏":["tong1","to butcher"],"力":["lik6","power; capability"],"功":["gung1","achievement; merit"],"加":["gaa1","add to; increase"],"匯":["wui6","a concourse; to flow together"],"午":["ng5","seventh earthly branch"],"半":["bun3","half"],"卡":["kaa1","card; punch card"],"卷":["gyun2","scroll; curl"],"厘":["lei4","manage; control"],"原":["jyun4","source; origin"],"叉":["caa1","crotch; fork"],"口":["hau2","mouth; open end"],"句":["geoi3","sentence"],"叮":["ding1","exhort or enjoin repeatedly"],"可":["ho2","may; can"],"司":["si1","take charge of; control"],"同":["tung4","same; similar"],"吞":["tan1","swallow; absorb"],"吾":["ng4","i; my"],"咁":["gam2","(Cant.) like this; in this way"],"咖":["gaa3","coffee; a phonetic"],"咼":["waa1","chat; jaw"],"品":["ban2","article; product"],"啡":["fe1","morphine; coffee"],"啲":["di1","(Cant.) a few"],"喜":["hei2","like; love"],"單":["daan1","single; individual"],"嗎":["maa1","final interrogative particle"],"嚿":["gau6","(Cant.) a lump; measure word"],"囗":["wai4","erect; proud"],"固":["gu3","to become solid; solidify"],"國":["gwok3","nation; country"],"園":["jyun4","garden; park"],"圓":["jyun4","circle; round"],"團":["tyun4","sphere; ball"],"土":["tou2","soil; earth"],"地":["dei6","earth; soil"],"報":["bou3","report; tell"],"墳":["fan4","grave; mound"],"士":["si6","scholar; gentleman"],"夕":["zik6","evening; night"],"夠":["gau3","enough; adequate"],"太":["taai3","very; too"],"始":["ci2","begin; start"],"子":["zi2","offspring; child"],"字":["zi6","letter; character"],"宋":["sung3","Song dynasty"],"完":["jyun4","complete; finish"],"定":["ding6","decide; settle"],"宵":["siu1","night; evening"],"家":["gaa1","house; home"],"寸":["cyun3","inch; small"],"小":["siu2","small; tiny"],"尸":["si1","corpse; to impersonate the dead"],"尼":["nei4","Buddhist nun; transliteration"],"屈":["wat1","bend; flex"],"山":["saan1","mountain; hill"],"左":["zo2","left; east"],"巨":["geoi6","large; great"],"已":["ji5","already; finished"],"市":["si5","market; fair"],"帖":["tip3","invitation card; notice"],"師":["si1","teacher; master"],"常":["soeng4","common; normal"],"幕":["mok6","curtain; screen"],"幫":["bong1","to help; assist"],"广":["gwong2","wide; extensive"],"底":["dai2","bottom; underneath"],"庫":["fu3","armory; treasury"],"廢":["fai3","abrogate; terminate"],"廣":["gwong2","broad; wide"],"廳":["teng1","hall; central room"],"形":["jing4","form; shape"],"彳":["cik1","step with left foot; rad. no 60"],"復":["fuk6","return; repeat"],"心":["sam1","heart; mind"],"思":["si1","think; consider"],"急":["gap1","quick; quickly"],"恢":["fui1","restore; big"],"恭":["gung1","respectful; polite"],"惡":["ok3","evil; wicked"],"想":["soeng2","think; speculate"],"意":["ji3","thought; idea"],"憶":["jik1","remember; reflect upon"],"成":["sing4","completed; finished"],"戲":["hei3","theatrical play; show"],"房":["fong4","house; building"],"手":["sau2","hand"],"扒":["paa4","scratch; dig up"],"打":["daa2","strike; hit"],"批":["pai1","comment; criticize"],"技":["gei6","skill; ability"],"抄":["caau1","copy; confiscate"],"拆":["caak3","to break up; split apart"],"拉":["laai1","pull; drag"],"招":["ziu1","beckon; summon"],"拜":["baai3","do obeisance; bow"],"掂":["dim1","heft; hold or weigh in palm"],"控":["hung3","accuse; charge"],"描":["miu4","copy; trace"],"換":["wun6","change; exchange"],"搞":["gaau2","to clear; clarify"],"搶":["coeng2","plunder; rob"],"收":["sau1","gather together; collect"],"改":["goi2","change; alter"],"故":["gu3","ancient; old"],"數":["sou3","number; several"],"料":["liu6","consider; conjecture"],"斤":["gan1","a catty (approximately 600 g); an axe"],"於":["jyu1","in; at"],"旅":["leoi5","trip; journey"],"既":["gei3","already; de facto"],"明":["ming4","bright; light"],"是":["si6","indeed; yes"],"時":["si4","time; season"],"晝":["zau3","daytime; daylight"],"曆":["lik6","calendar; era"],"書":["syu1","book; letter"],"會":["wui6","to assemble; meet together"],"木":["muk6","tree; wood"],"未":["mei6","not yet; eighth earthly branch"],"本":["bun2","root; origin"],"東":["dung1","east; eastern"],"枱":["toi2","a table; desk"],"柚":["jau2","pomelo; grapefruit"],"校":["haau6","school; military field officer"],"格":["gaak3","pattern; standard"],"條":["tiu4","clause; condition"],"樂":["lok6","happy; glad"],"樣":["joeng6","shape; form"],"檸":["ning4","lemon"],"歌":["go1","song; lyrics"],"止":["zi2","stop; halt"],"正":["zing3","right; proper"],"死":["sei2","die; dead"],"殘":["caan4","injure; spoil"],"每":["mui5","every; each"],"氣":["hei3","air; gas"],"氵":["seoi2","water; radical number 85"],"汽":["hei3","steam; vapor"],"河":["ho4","river; stream"],"油":["jau4","oil; fat"],"法":["faat3","law; rule"],"波":["bo1","waves; breakers"],"洗":["sai2","wash; rinse"],"洲":["zau1","continent; island"],"浴":["juk6","bathe; wash"],"清":["cing1","clear; pure"],"港":["gong2","port; harbor"],"湯":["tong1","hot water; soup"],"源":["jyun4","spring; source"],"滿":["mun5","fill; full"],"火":["fo2","fire; flame"],"灰":["fui1","ashes; dust"],"炆":["man1","(Cant.) to simmer; cook over a slow fire"],"炒":["caau2","fry; saute"],"無":["mou4","negative; no"],"煮":["zyu2","cook"],"煙":["jin1","smoke; soot"],"蒸":["zing1","steam; evaporate"],"熟":["suk6","well-cooked; ripe"],"燈":["dang1","lantern; lamp"],"燒":["siu1","burn; bake"],"父":["fu6","father"],"片":["pin3","slice; splinter"],"版":["baan2","printing blocks; edition"],"牌":["paai4","signboard; placard"],"牙":["ngaa4","tooth; molars"],"牛":["ngau4","cow; ox"],"物":["mat6","thing; substance"],"狂":["kong4","insane; mad"],"環":["waan4","jade ring or bracelet; ring"],"甘":["gam1","sweetness; sweet"],"生":["sang1","life; living"],"田":["tin4","field; arable land"],"甲":["gaap3","armor; shell"],"男":["naam4","male; man"],"畢":["bat1","end; finish"],"疾":["zat6","illness; disease"],"登":["dang1","rise; mount"],"發":["faat3","issue; dispatch"],"白":["baak6","white; pure"],"目":["muk6","eye; look"],"眼":["ngaan5","eye; eyelet"],"着":["zoek6","make move; take action"],"矢":["ci2","arrow; dart"],"石":["sek6","stone; rock"],"破":["po3","break; ruin"],"確":["kok3","sure; certain"],"示":["si6","show; manifest"],"祖":["zou2","ancestor; forefather"],"禮":["lai5","social custom; manners"],"穩":["wan2","stable; firm"],"空":["hung1","empty; hollow"],"立":["lap6","stand; let stand"],"笑":["siu3","smile; laugh"],"第":["dai6","sequence; number"],"筆":["bat1","writing brush; write"],"等":["dang2","rank; grade"],"答":["daap3","answer; reply"],"简":["gaan2","simple; terse"],"範":["faan6","pattern; model"],"簿":["bou6","register; account book"],"籠":["lung4","cage; cage-like basket"],"米":["mai5","hulled or husked uncooked rice"],"粵":["jyut6","Guangdong and Guangxi provinces; initial particle"],"糉":["zung2","dumpling made of glutinous rice"],"糸":["mik6","silk"],"系":["hai6","system; line"],"紀":["gei2","record; annal"],"紅":["hung4","red; vermillion"],"組":["zou2","class; section"],"練":["lin6","practice; drill"],"羅":["lo4","net for catching birds; gauze"],"羊":["joeng4","sheep; goat"],"習":["zaap6","practice; flapping wings"],"者":["ze2","that which; he who"],"而":["ji4","and; and then"],"耐":["noi6","endure; bear"],"耳":["ji5","ear; merely"],"聖":["sing3","holy; sacred"],"聲":["sing1","sound; voice"],"肥":["fei4","fat; plump"],"能":["nang4","to be able; can"],"腩":["naam5","(Cant.) fatty meat on a cow's belly; abdomen"],"臼":["kau5","mortar; bone joint socket"],"興":["hing1","thrive; prosper"],"舌":["sit3","tongue; clapper of bell"],"舟":["zau1","boat; ship"],"色":["sik1","color; tint"],"艸":["cou2","grass"],"花":["faa1","flower; blossoms"],"英":["jing1","petal; flower"],"菊":["guk1","chrysanthemum"],"菠":["bo1","spinach and similar greens"],"蓉":["jung4","hibiscus; Chengdu"],"薑":["goeng1","ginger"],"蘿":["lo4","type of creeping plant; turnip"],"蛋":["daan6","eggs; term of abuse"],"衣":["ji1","clothes; clothing"],"表":["biu2","show; express"],"衫":["saam1","shirt; robe"],"褲":["fu3","trousers; pants"],"西":["sai1","west(ern); westward"],"覺":["gok3","to wake up from sleep; conscious"],"觸":["zuk1","touch; butt"],"言":["jin4","words; speech"],"記":["gei3","record; keep in mind"],"設":["cit3","build; establish"],"詞":["ci4","words; phrase"],"試":["si3","test; try"],"認":["jing6","recognize; know"],"誕":["daan3","to bear children; give birth"],"語":["jyu5","language; words"],"課":["fo3","lesson; course"],"讀":["duk6","read; study"],"豬":["zyu1","pig; hog"],"貝":["bui3","sea shell; money"],"財":["coi4","wealth; valuables"],"資":["zi1","property; wealth"],"賞":["soeng2","reward; grant"],"走":["zau2","walk; go on foot"],"趣":["ceoi3","what attracts one's attention"],"路":["lou6","road; path"],"身":["san1","body; trunk"],"辦":["baan6","manage; do"],"辨":["bin6","distinguish; discriminate"],"辶":["caang1","walk; walking"],"逗":["dau6","tempt; allure"],"速":["cuk1","quick; prompt"],"連":["lin4","join; connect"],"週":["zau1","week; turn"],"運":["wan6","luck; fortune"],"遲":["ci4","late; tardy"],"邪":["ce4","wrong; evil"],"部":["bou6","part; division"],"酒":["zau2","wine; spirits"],"醮":["ziu3","religious service; Daoist or Buddhist ceremony"],"重":["cung5","heavy; weighty"],"野":["je5","open country; field"],"金":["gam1","gold; metals in general"],"錄":["luk6","copy; write down"],"錢":["cin4","money; currency"],"錯":["co3","error; blunder"],"鑊":["wok6","cauldron; large iron pot"],"門":["mun4","gate; door"],"開":["hoi1","open; initiate"],"間":["gaan1","interval; space"],"閱":["jyut6","examine; inspect"],"關":["gwaan1","frontier pass; close"],"阿":["aa3","prefix for people's names"],"除":["ceoi4","eliminate; remove"],"陽":["joeng4","the active; light"],"隊":["deoi6","team; group"],"雞":["gai1","chickens; domestic fowl"],"離":["lei4","leave; depart"],"難":["naan4","difficult; arduous"],"雨":["jyu5","rain; rainy"],"雲":["wan4","clouds; Yunnan province"],"電":["din6","electricity; electric"],"青":["cing1","blue; green"],"面":["min6","face; surface"],"音":["jam1","sound; tone"],"順":["seon6","obey; submit to"],"預":["jyu6","prepare; arrange"],"頭":["tau4","head; top"],"題":["tai4","forehead; title"],"飄":["piu1","whirlwind; cyclone"],"飛":["fei1","fly; go quickly"],"飾":["sik1","decorate; ornament"],"餅":["beng2","rice-cakes; biscuits"],"餐":["caan1","eat; dine"],"首":["sau2","head; first"],"香":["hoeng1","fragrant; sweet-smelling"],"馬":["maa5","horse"],"魚":["jyu4","fish"],"鮮":["sin1","fresh; new"],"麥":["mak6","wheat; barley"],"黎":["lai4","numerous; many"],"黑":["hak1","black; dark"],"默":["mak6","silent; quiet"],"鼓":["gu2","drum; beat"],"齊":["cai4","even; uniform"],"龍":["lung4","dragon"]};
